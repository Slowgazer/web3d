...
export class SceneEditor {
  ...
  _handleKeyDown(e) {
    ...
    if (!this.editMode || this._isTyping(e)) return

    const mod = e.ctrlKey || e.metaKey
    if (mod && e.code === 'KeyS') { e.preventDefault(); this.save(); this._toast('已保存到本地'); return }
    ...
    if (mod && e.code === 'KeyD') { e.preventDefault(); this.duplicateSelected(); return }
    ...
    switch (e.code) {
      ...
      case 'KeyQ': this.setSpace(this.space === 'world' ? 'local' : 'world'); break
