...
export function createRailwayTrackSegmentModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  materialMap["earth-clay"] = createSculptMaterial(
    "earth-clay",
    {"id": "earth-clay", "name": "Grey Stone Embankment", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#8d8d8a", "color": "#8d8d8a", "albedo": {"dominant": "#8d8d8a", "secondary": ["#6e6e6b"], "samplingNotes": "reference crop palette"}, "colorVariation": {"palette": ["#9a9a97", "#7c7c79", "#a8a8a4"], "pattern": "mottled", "amplitude": 0.18, "heightCorrelation": 0.35}, "textureResolution": 1024, "textureProjection": {"mode": "box-projection", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensity": "uniform world-space, 1024px per 2.4 world units"}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.4, "pattern": "broad color zones", "role": "color-zone variation"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.22, "pattern": "grain / gravel / sleat seams", "role": "surface relief"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.08, "pattern": "paper grain highlight breakup", "role": "fine grain"}], "roughness": {"base": 0.85, "variation": 0.16, "map": "earth-clay-roughness", "localResponse": "rougher in cavities, slightly lower on worn edges"}, "metalness": {"base": 0.0, "variation": 0.05}, "normal": {"pattern": "derived-from-independent-height-field", "strength": 0.24, "scale": 24.0, "space": "tangent"}, "bump": {"pattern": "none", "amplitude": 0.0, "scale": 1.0}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.3, "contactShadowBias": 0.35, "response": "cavity darkening between gravel, under sleepers, at rail web"}, "wear": {"edgeWear": 0.2, "scratches": ["rail web rust streaks"], "chips": []}, "dirt": {"amount": 0.25, "cavityBias": 0.5, "color": "#5A4A32"}, "localOverrides": [{"id": "clay-vertical-streak", "zone": "embankment face", "albedo": "#6e6e6b", "roughness": 0.9, "description": "vertical water-streak staining down the grey stone face"}, {"id": "clay-base-pebbles", "zone": "embankment base", "albedo": "#a8a8a4", "description": "scattered loose pebbles and lighter dust at the foot of the slope"}], "qualityTier": "utility"},
    options
  );
  materialMap["ballast-gravel"] = createSculptMaterial(
    "ballast-gravel",
    {"id": "ballast-gravel", "name": "Grey Ballast", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#9b9b97", "color": "#9b9b97", "albedo": {"dominant": "#9b9b97", "secondary": ["#7c7c78"], "samplingNotes": "reference crop palette"}, "colorVariation": {"palette": ["#a6a6a2", "#8b8b87", "#727270"], "pattern": "mottled", "amplitude": 0.18, "heightCorrelation": 0.35}, "textureResolution": 1024, "textureProjection": {"mode": "box-projection", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensity": "uniform world-space, 1024px per 2.4 world units"}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.4, "pattern": "broad color zones", "role": "color-zone variation"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.22, "pattern": "grain / gravel / sleat seams", "role": "surface relief"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.08, "pattern": "paper grain highlight breakup", "role": "fine grain"}], "roughness": {"base": 0.8, "variation": 0.16, "map": "ballast-gravel-roughness", "localResponse": "rougher in cavities, slightly lower on worn edges"}, "metalness": {"base": 0.0, "variation": 0.05}, "normal": {"pattern": "derived-from-independent-height-field", "strength": 0.3, "scale": 24.0, "space": "tangent"}, "bump": {"pattern": "none", "amplitude": 0.0, "scale": 1.0}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.3, "contactShadowBias": 0.35, "response": "cavity darkening between gravel, under sleepers, at rail web"}, "wear": {"edgeWear": 0.2, "scratches": ["rail web rust streaks"], "chips": []}, "dirt": {"amount": 0.25, "cavityBias": 0.5, "color": "#5A4A32"}, "localOverrides": [{"id": "gravel-mottle", "zone": "ballast top", "albedo": "#9b9b97", "description": "mixed light/dark grey rounded stone mottling"}], "qualityTier": "utility"},
    options
  );
  materialMap["rail-steel"] = createSculptMaterial(
    "rail-steel",
    {"id": "rail-steel", "name": "Rail Steel", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#a9aeb5", "color": "#a9aeb5", "albedo": {"dominant": "#a9aeb5", "secondary": ["#6b7076"], "samplingNotes": "reference crop palette"}, "colorVariation": {"palette": ["#c2c7cd", "#8f959c", "#5f646a"], "pattern": "mottled", "amplitude": 0.18, "heightCorrelation": 0.35}, "textureResolution": 1024, "textureProjection": {"mode": "box-projection", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensity": "uniform world-space, 1024px per 2.4 world units"}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.4, "pattern": "broad color zones", "role": "color-zone variation"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.22, "pattern": "grain / gravel / sleat seams", "role": "surface relief"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.08, "pattern": "paper grain highlight breakup", "role": "fine grain"}], "roughness": {"base": 0.32, "variation": 0.16, "map": "rail-steel-roughness", "localResponse": "rougher in cavities, slightly lower on worn edges"}, "metalness": {"base": 0.8, "variation": 0.05}, "normal": {"pattern": "derived-from-independent-height-field", "strength": 0.18, "scale": 24.0, "space": "tangent"}, "bump": {"pattern": "none", "amplitude": 0.0, "scale": 1.0}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.3, "contactShadowBias": 0.35, "response": "cavity darkening between gravel, under sleepers, at rail web"}, "wear": {"edgeWear": 0.2, "scratches": ["rail web rust streaks"], "chips": []}, "dirt": {"amount": 0.25, "cavityBias": 0.5, "color": "#5A4A32"}, "localOverrides": [{"id": "rail-web-rust", "zone": "rail web", "albedo": "#5f646a", "roughness": 0.7, "description": "darker grey web below the polished head"}, {"id": "railhead-specular", "zone": "railhead", "albedo": "#c9cfd6", "roughness": 0.2, "description": "bright polished running surface catching the light"}], "qualityTier": "utility"},
    options
  );
  materialMap["sleeper-wood"] = createSculptMaterial(
    "sleeper-wood",
    {"id": "sleeper-wood", "name": "Dark Sleeper", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#4a423a", "color": "#4a423a", "albedo": {"dominant": "#4a423a", "secondary": ["#332d27"], "samplingNotes": "reference crop palette"}, "colorVariation": {"palette": ["#5a5048", "#3d372f", "#2a251f"], "pattern": "mottled", "amplitude": 0.18, "heightCorrelation": 0.35}, "textureResolution": 1024, "textureProjection": {"mode": "box-projection", "repeat": [2.0, 2.0], "anisotropy": 8, "texelDensity": "uniform world-space, 1024px per 2.4 world units"}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.4, "pattern": "broad color zones", "role": "color-zone variation"}, {"id": "meso", "frequency": 12.0, "amplitude": 0.22, "pattern": "grain / gravel / sleat seams", "role": "surface relief"}, {"id": "micro", "frequency": 56.0, "amplitude": 0.08, "pattern": "paper grain highlight breakup", "role": "fine grain"}], "roughness": {"base": 0.86, "variation": 0.16, "map": "sleeper-wood-roughness", "localResponse": "rougher in cavities, slightly lower on worn edges"}, "metalness": {"base": 0.0, "variation": 0.05}, "normal": {"pattern": "derived-from-independent-height-field", "strength": 0.34, "scale": 24.0, "space": "tangent"}, "bump": {"pattern": "none", "amplitude": 0.0, "scale": 1.0}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.3, "contactShadowBias": 0.35, "response": "cavity darkening between gravel, under sleepers, at rail web"}, "wear": {"edgeWear": 0.2, "scratches": ["rail web rust streaks"], "chips": []}, "dirt": {"amount": 0.25, "cavityBias": 0.5, "color": "#5A4A32"}, "localOverrides": [{"id": "sleeper-end-crack", "zone": "sleeper end", "albedo": "#2a251f", "description": "dark longitudinal crack opening at the tie end"}], "qualityTier": "utility"},
    options
  );
  ...
  const mesh_embankment_1Geometry = endpoint_embankment_1
    ...
    : buildExtrudeGeometry({"points": [[-1.95, -0.35], [1.95, -0.35], [1.45, 0.35], [-1.45, 0.35]], "depth": 4.0});
  if (!endpoint_embankment_1) {
  ...
  node_ballast_bed_2.userData.sculptComponent = {"id": "ballast-bed", "name": "BallastBed", "level": "macro", "role": "bedding", "importance": 1.0, "confidence": 0.88, "primitive": "extrude", "topologyClass": "assembled-solid", "topologyRationale": "Grey gravel ballast strip cradling the sleepers on the embankment top.", "parent": "embankment", "attachment": {"parentId": "embankment", "parentSocket": "embankment-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 1, "height": 1, "depth": 1, "units": "world", "confidence": 0.88}, "transform": {"position": [0, 0.35, 0], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.88, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "bedding", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "ballast-bed", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": ["gravel-mottle"], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement", "geometryDescriptor": {"profile2D": {"points": [[-1.2, 0.0], [1.2, 0.0], [1.02, 0.13], [-1.02, 0.13]], "depth": 4.0}, "topologyIntent": "extruded gravel shoulder"}};
  ...
  const mesh_ballast_bed_2Geometry = endpoint_ballast_bed_2
    ...
    : buildExtrudeGeometry({"points": [[-1.2, 0.0], [1.2, 0.0], [1.02, 0.13], [-1.02, 0.13]], "depth": 4.0});
  if (!endpoint_ballast_bed_2) {
  ...
  if (endpoint_rail_left_3) {
    ...
    node_rail_left_3.position.set(-0.97, 0.19, 2.0);
    node_rail_left_3.rotation.set(0.0, 0.0, 0.0);
  }
  node_rail_left_3.userData.sculptComponent = {"id": "rail-left", "name": "RailLeft", "level": "macro", "role": "rail", "importance": 1.0, "confidence": 0.85, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "Steel rail at the wheel gauge (z=-0.97).", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.1, "height": 0.12, "depth": 4.0, "units": "world", "confidence": 0.85}, "transform": {"position": [-0.97, 0.19, 2.0], "rotation": [0, 0, 0], "scale": [0.1, 0.12, 4.0]}, "material": "rail-steel", "materialLayers": ["rail-steel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(169, 174, 181, 1.0)", "secondaryAlbedo": "rgba(107, 112, 118, 1.0)", "materialClass": "metal", "materialClassConfidence": 0.85, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "rail", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rail-left", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": ["railhead-specular"], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  ...
  const mesh_rail_left_3Geometry = endpoint_rail_left_3
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_rail_left_3) {
    mesh_rail_left_3Geometry.scale(0.1, 0.12, 4.0);
  }
  ...
  mesh_rail_left_3.userData.sculptComponent = {"id": "rail-left", "name": "RailLeft", "level": "macro", "role": "rail", "importance": 1.0, "confidence": 0.85, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "Steel rail at the wheel gauge (z=-0.97).", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.1, "height": 0.12, "depth": 4.0, "units": "world", "confidence": 0.85}, "transform": {"position": [-0.97, 0.19, 2.0], "rotation": [0, 0, 0], "scale": [0.1, 0.12, 4.0]}, "material": "rail-steel", "materialLayers": ["rail-steel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(169, 174, 181, 1.0)", "secondaryAlbedo": "rgba(107, 112, 118, 1.0)", "materialClass": "metal", "materialClassConfidence": 0.85, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "rail", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rail-left", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": ["railhead-specular"], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  ...
  const mesh_rail_right_4Geometry = endpoint_rail_right_4
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_rail_right_4) {
    mesh_rail_right_4Geometry.scale(0.1, 0.12, 4.0);
  }
  ...
  const mesh_railhead_left_5Geometry = endpoint_railhead_left_5
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_railhead_left_5) {
    mesh_railhead_left_5Geometry.scale(0.11, 0.02, 4.0);
  }
  ...
  const mesh_railhead_right_6Geometry = endpoint_railhead_right_6
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_railhead_right_6) {
    mesh_railhead_right_6Geometry.scale(0.11, 0.02, 4.0);
  }
  ...
  const mesh_sleeper_01_7Geometry = endpoint_sleeper_01_7
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_sleeper_01_7) {
    mesh_sleeper_01_7Geometry.scale(2.5, 0.09, 0.26);
  }
  ...
  const mesh_sleeper_02_8Geometry = endpoint_sleeper_02_8
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_sleeper_02_8) {
    mesh_sleeper_02_8Geometry.scale(2.5, 0.09, 0.26);
  }
  ...
  const mesh_sleeper_03_9Geometry = endpoint_sleeper_03_9
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_sleeper_03_9) {
    mesh_sleeper_03_9Geometry.scale(2.5, 0.09, 0.26);
  }
  ...
  const mesh_sleeper_04_10Geometry = endpoint_sleeper_04_10
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_sleeper_04_10) {
    mesh_sleeper_04_10Geometry.scale(2.5, 0.09, 0.26);
  }
  ...
  const mesh_sleeper_05_11Geometry = endpoint_sleeper_05_11
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_sleeper_05_11) {
    mesh_sleeper_05_11Geometry.scale(2.5, 0.09, 0.26);
  }
  ...
  const mesh_sleeper_06_12Geometry = endpoint_sleeper_06_12
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_sleeper_06_12) {
    mesh_sleeper_06_12Geometry.scale(2.5, 0.09, 0.26);
  }
  ...
  const mesh_sleeper_07_13Geometry = endpoint_sleeper_07_13
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_sleeper_07_13) {
    mesh_sleeper_07_13Geometry.scale(2.5, 0.09, 0.26);
  }
  ...
  const mesh_sleeper_08_14Geometry = endpoint_sleeper_08_14
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_sleeper_08_14) {
    mesh_sleeper_08_14Geometry.scale(2.5, 0.09, 0.26);
  }
  ...
  const mesh_sleeper_09_15Geometry = endpoint_sleeper_09_15
    ...
    : new THREE.BoxGeometry(1, 1, 1, 12, 12, 12);
  if (!endpoint_sleeper_09_15) {
    mesh_sleeper_09_15Geometry.scale(2.5, 0.09, 0.26);
  }
  ...
  const endpoint_pebble_01_16 = makeAttachmentEndpoint(null);
  const node_pebble_01_16 = new THREE.Group();
  node_pebble_01_16.name = "Pebble01__pivot";
  node_pebble_01_16.scale.set(1, 1, 1);
  if (endpoint_pebble_01_16) {
    node_pebble_01_16.position.copy(endpoint_pebble_01_16.start);
    node_pebble_01_16.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_pebble_01_16.position.set(0.75, 0.14575, 0.6);
    node_pebble_01_16.rotation.set(0.0, 0.0, 0.0);
  }
  node_pebble_01_16.userData.sculptComponent = {"id": "pebble-01", "name": "Pebble01", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble resting on the ballast.", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.09, "height": 0.063, "depth": 0.09, "units": "world", "confidence": 0.7}, "transform": {"position": [0.75, 0.14575, 0.6], "rotation": [0, 0, 0], "scale": [0.09, 0.063, 0.09]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-01", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_01_16.userData.actionProfile = {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-01", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["ballast-bed"] ?? root).add(node_pebble_01_16);
  nodes["pebble-01"] = node_pebble_01_16;
  const mesh_pebble_01_16Geometry = endpoint_pebble_01_16
    ? new THREE.CylinderGeometry(endpoint_pebble_01_16.endRadius, endpoint_pebble_01_16.baseRadius, endpoint_pebble_01_16.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_pebble_01_16) {
    mesh_pebble_01_16Geometry.scale(0.09, 0.063, 0.09);
  }
  const mesh_pebble_01_16 = new THREE.Mesh(
    mesh_pebble_01_16Geometry,
    materialMap["ballast-gravel"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_pebble_01_16.name = "Pebble01";
  if (endpoint_pebble_01_16) {
    mesh_pebble_01_16.position.copy(endpoint_pebble_01_16.midpoint);
    mesh_pebble_01_16.quaternion.copy(endpoint_pebble_01_16.quaternion);
  }
  mesh_pebble_01_16.castShadow = options.castShadow ?? true;
  mesh_pebble_01_16.receiveShadow = options.receiveShadow ?? true;
  mesh_pebble_01_16.userData.sculptComponent = {"id": "pebble-01", "name": "Pebble01", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble resting on the ballast.", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.09, "height": 0.063, "depth": 0.09, "units": "world", "confidence": 0.7}, "transform": {"position": [0.75, 0.14575, 0.6], "rotation": [0, 0, 0], "scale": [0.09, 0.063, 0.09]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-01", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_01_16.add(mesh_pebble_01_16);
  meshes["pebble-01"] = mesh_pebble_01_16;
  colliders["pebble-01"] = {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["pebble-01"] ??= [];
  destructionGroups["pebble-01"].push(node_pebble_01_16);

  const endpoint_pebble_02_17 = makeAttachmentEndpoint(null);
  const node_pebble_02_17 = new THREE.Group();
  node_pebble_02_17.name = "Pebble02__pivot";
  node_pebble_02_17.scale.set(1, 1, 1);
  if (endpoint_pebble_02_17) {
    node_pebble_02_17.position.copy(endpoint_pebble_02_17.start);
    node_pebble_02_17.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_pebble_02_17.position.set(-0.7, 0.14925, 1.3);
    node_pebble_02_17.rotation.set(0.0, 0.0, 0.0);
  }
  node_pebble_02_17.userData.sculptComponent = {"id": "pebble-02", "name": "Pebble02", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble resting on the ballast.", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.11, "height": 0.077, "depth": 0.11, "units": "world", "confidence": 0.7}, "transform": {"position": [-0.7, 0.14925, 1.3], "rotation": [0, 0, 0], "scale": [0.11, 0.077, 0.11]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-02", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_02_17.userData.actionProfile = {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-02", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["ballast-bed"] ?? root).add(node_pebble_02_17);
  nodes["pebble-02"] = node_pebble_02_17;
  const mesh_pebble_02_17Geometry = endpoint_pebble_02_17
    ? new THREE.CylinderGeometry(endpoint_pebble_02_17.endRadius, endpoint_pebble_02_17.baseRadius, endpoint_pebble_02_17.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_pebble_02_17) {
    mesh_pebble_02_17Geometry.scale(0.11, 0.077, 0.11);
  }
  const mesh_pebble_02_17 = new THREE.Mesh(
    mesh_pebble_02_17Geometry,
    materialMap["ballast-gravel"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_pebble_02_17.name = "Pebble02";
  if (endpoint_pebble_02_17) {
    mesh_pebble_02_17.position.copy(endpoint_pebble_02_17.midpoint);
    mesh_pebble_02_17.quaternion.copy(endpoint_pebble_02_17.quaternion);
  }
  mesh_pebble_02_17.castShadow = options.castShadow ?? true;
  mesh_pebble_02_17.receiveShadow = options.receiveShadow ?? true;
  mesh_pebble_02_17.userData.sculptComponent = {"id": "pebble-02", "name": "Pebble02", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble resting on the ballast.", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.11, "height": 0.077, "depth": 0.11, "units": "world", "confidence": 0.7}, "transform": {"position": [-0.7, 0.14925, 1.3], "rotation": [0, 0, 0], "scale": [0.11, 0.077, 0.11]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-02", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_02_17.add(mesh_pebble_02_17);
  meshes["pebble-02"] = mesh_pebble_02_17;
  colliders["pebble-02"] = {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["pebble-02"] ??= [];
  destructionGroups["pebble-02"].push(node_pebble_02_17);

  const endpoint_pebble_03_18 = makeAttachmentEndpoint(null);
  const node_pebble_03_18 = new THREE.Group();
  node_pebble_03_18.name = "Pebble03__pivot";
  node_pebble_03_18.scale.set(1, 1, 1);
  if (endpoint_pebble_03_18) {
    node_pebble_03_18.position.copy(endpoint_pebble_03_18.start);
    node_pebble_03_18.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_pebble_03_18.position.set(0.45, 0.15275, 2.1);
    node_pebble_03_18.rotation.set(0.0, 0.0, 0.0);
  }
  node_pebble_03_18.userData.sculptComponent = {"id": "pebble-03", "name": "Pebble03", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble resting on the ballast.", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.13, "height": 0.091, "depth": 0.13, "units": "world", "confidence": 0.7}, "transform": {"position": [0.45, 0.15275, 2.1], "rotation": [0, 0, 0], "scale": [0.13, 0.091, 0.13]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-03", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_03_18.userData.actionProfile = {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-03", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["ballast-bed"] ?? root).add(node_pebble_03_18);
  nodes["pebble-03"] = node_pebble_03_18;
  const mesh_pebble_03_18Geometry = endpoint_pebble_03_18
    ? new THREE.CylinderGeometry(endpoint_pebble_03_18.endRadius, endpoint_pebble_03_18.baseRadius, endpoint_pebble_03_18.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_pebble_03_18) {
    mesh_pebble_03_18Geometry.scale(0.13, 0.091, 0.13);
  }
  const mesh_pebble_03_18 = new THREE.Mesh(
    mesh_pebble_03_18Geometry,
    materialMap["ballast-gravel"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_pebble_03_18.name = "Pebble03";
  if (endpoint_pebble_03_18) {
    mesh_pebble_03_18.position.copy(endpoint_pebble_03_18.midpoint);
    mesh_pebble_03_18.quaternion.copy(endpoint_pebble_03_18.quaternion);
  }
  mesh_pebble_03_18.castShadow = options.castShadow ?? true;
  mesh_pebble_03_18.receiveShadow = options.receiveShadow ?? true;
  mesh_pebble_03_18.userData.sculptComponent = {"id": "pebble-03", "name": "Pebble03", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble resting on the ballast.", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.13, "height": 0.091, "depth": 0.13, "units": "world", "confidence": 0.7}, "transform": {"position": [0.45, 0.15275, 2.1], "rotation": [0, 0, 0], "scale": [0.13, 0.091, 0.13]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-03", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_03_18.add(mesh_pebble_03_18);
  meshes["pebble-03"] = mesh_pebble_03_18;
  colliders["pebble-03"] = {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["pebble-03"] ??= [];
  destructionGroups["pebble-03"].push(node_pebble_03_18);

  const endpoint_pebble_04_19 = makeAttachmentEndpoint(null);
  const node_pebble_04_19 = new THREE.Group();
  node_pebble_04_19.name = "Pebble04__pivot";
  node_pebble_04_19.scale.set(1, 1, 1);
  if (endpoint_pebble_04_19) {
    node_pebble_04_19.position.copy(endpoint_pebble_04_19.start);
    node_pebble_04_19.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_pebble_04_19.position.set(-0.8, 0.14575, 2.8);
    node_pebble_04_19.rotation.set(0.0, 0.0, 0.0);
  }
  node_pebble_04_19.userData.sculptComponent = {"id": "pebble-04", "name": "Pebble04", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble resting on the ballast.", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.09, "height": 0.063, "depth": 0.09, "units": "world", "confidence": 0.7}, "transform": {"position": [-0.8, 0.14575, 2.8], "rotation": [0, 0, 0], "scale": [0.09, 0.063, 0.09]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-04", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_04_19.userData.actionProfile = {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-04", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["ballast-bed"] ?? root).add(node_pebble_04_19);
  nodes["pebble-04"] = node_pebble_04_19;
  const mesh_pebble_04_19Geometry = endpoint_pebble_04_19
    ? new THREE.CylinderGeometry(endpoint_pebble_04_19.endRadius, endpoint_pebble_04_19.baseRadius, endpoint_pebble_04_19.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_pebble_04_19) {
    mesh_pebble_04_19Geometry.scale(0.09, 0.063, 0.09);
  }
  const mesh_pebble_04_19 = new THREE.Mesh(
    mesh_pebble_04_19Geometry,
    materialMap["ballast-gravel"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_pebble_04_19.name = "Pebble04";
  if (endpoint_pebble_04_19) {
    mesh_pebble_04_19.position.copy(endpoint_pebble_04_19.midpoint);
    mesh_pebble_04_19.quaternion.copy(endpoint_pebble_04_19.quaternion);
  }
  mesh_pebble_04_19.castShadow = options.castShadow ?? true;
  mesh_pebble_04_19.receiveShadow = options.receiveShadow ?? true;
  mesh_pebble_04_19.userData.sculptComponent = {"id": "pebble-04", "name": "Pebble04", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble resting on the ballast.", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.09, "height": 0.063, "depth": 0.09, "units": "world", "confidence": 0.7}, "transform": {"position": [-0.8, 0.14575, 2.8], "rotation": [0, 0, 0], "scale": [0.09, 0.063, 0.09]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-04", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_04_19.add(mesh_pebble_04_19);
  meshes["pebble-04"] = mesh_pebble_04_19;
  colliders["pebble-04"] = {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["pebble-04"] ??= [];
  destructionGroups["pebble-04"].push(node_pebble_04_19);

  const endpoint_pebble_05_20 = makeAttachmentEndpoint(null);
  const node_pebble_05_20 = new THREE.Group();
  node_pebble_05_20.name = "Pebble05__pivot";
  node_pebble_05_20.scale.set(1, 1, 1);
  if (endpoint_pebble_05_20) {
    node_pebble_05_20.position.copy(endpoint_pebble_05_20.start);
    node_pebble_05_20.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_pebble_05_20.position.set(0.92, 0.14925, 3.4);
    node_pebble_05_20.rotation.set(0.0, 0.0, 0.0);
  }
  node_pebble_05_20.userData.sculptComponent = {"id": "pebble-05", "name": "Pebble05", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble resting on the ballast.", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.11, "height": 0.077, "depth": 0.11, "units": "world", "confidence": 0.7}, "transform": {"position": [0.92, 0.14925, 3.4], "rotation": [0, 0, 0], "scale": [0.11, 0.077, 0.11]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-05", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_05_20.userData.actionProfile = {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-05", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["ballast-bed"] ?? root).add(node_pebble_05_20);
  nodes["pebble-05"] = node_pebble_05_20;
  const mesh_pebble_05_20Geometry = endpoint_pebble_05_20
    ? new THREE.CylinderGeometry(endpoint_pebble_05_20.endRadius, endpoint_pebble_05_20.baseRadius, endpoint_pebble_05_20.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_pebble_05_20) {
    mesh_pebble_05_20Geometry.scale(0.11, 0.077, 0.11);
  }
  const mesh_pebble_05_20 = new THREE.Mesh(
    mesh_pebble_05_20Geometry,
    materialMap["ballast-gravel"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_pebble_05_20.name = "Pebble05";
  if (endpoint_pebble_05_20) {
    mesh_pebble_05_20.position.copy(endpoint_pebble_05_20.midpoint);
    mesh_pebble_05_20.quaternion.copy(endpoint_pebble_05_20.quaternion);
  }
  mesh_pebble_05_20.castShadow = options.castShadow ?? true;
  mesh_pebble_05_20.receiveShadow = options.receiveShadow ?? true;
  mesh_pebble_05_20.userData.sculptComponent = {"id": "pebble-05", "name": "Pebble05", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble resting on the ballast.", "parent": "ballast-bed", "attachment": {"parentId": "ballast-bed", "parentSocket": "ballast-bed-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.11, "height": 0.077, "depth": 0.11, "units": "world", "confidence": 0.7}, "transform": {"position": [0.92, 0.14925, 3.4], "rotation": [0, 0, 0], "scale": [0.11, 0.077, 0.11]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-05", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_05_20.add(mesh_pebble_05_20);
  meshes["pebble-05"] = mesh_pebble_05_20;
  colliders["pebble-05"] = {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["pebble-05"] ??= [];
  destructionGroups["pebble-05"].push(node_pebble_05_20);

  const endpoint_pebble_06_21 = makeAttachmentEndpoint(null);
  const node_pebble_06_21 = new THREE.Group();
  node_pebble_06_21.name = "Pebble06__pivot";
  node_pebble_06_21.scale.set(1, 1, 1);
  if (endpoint_pebble_06_21) {
    node_pebble_06_21.position.copy(endpoint_pebble_06_21.start);
    node_pebble_06_21.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_pebble_06_21.position.set(-1.7, -0.33425, 1.0);
    node_pebble_06_21.rotation.set(0.0, 0.0, 0.0);
  }
  node_pebble_06_21.userData.sculptComponent = {"id": "pebble-06", "name": "Pebble06", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble at the foot of the embankment.", "parent": "embankment", "attachment": {"parentId": "embankment", "parentSocket": "embankment-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.09, "height": 0.063, "depth": 0.09, "units": "world", "confidence": 0.7}, "transform": {"position": [-1.7, -0.33425, 1.0], "rotation": [0, 0, 0], "scale": [0.09, 0.063, 0.09]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-06", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_06_21.userData.actionProfile = {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-06", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["embankment"] ?? root).add(node_pebble_06_21);
  nodes["pebble-06"] = node_pebble_06_21;
  const mesh_pebble_06_21Geometry = endpoint_pebble_06_21
    ? new THREE.CylinderGeometry(endpoint_pebble_06_21.endRadius, endpoint_pebble_06_21.baseRadius, endpoint_pebble_06_21.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_pebble_06_21) {
    mesh_pebble_06_21Geometry.scale(0.09, 0.063, 0.09);
  }
  const mesh_pebble_06_21 = new THREE.Mesh(
    mesh_pebble_06_21Geometry,
    materialMap["ballast-gravel"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_pebble_06_21.name = "Pebble06";
  if (endpoint_pebble_06_21) {
    mesh_pebble_06_21.position.copy(endpoint_pebble_06_21.midpoint);
    mesh_pebble_06_21.quaternion.copy(endpoint_pebble_06_21.quaternion);
  }
  mesh_pebble_06_21.castShadow = options.castShadow ?? true;
  mesh_pebble_06_21.receiveShadow = options.receiveShadow ?? true;
  mesh_pebble_06_21.userData.sculptComponent = {"id": "pebble-06", "name": "Pebble06", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble at the foot of the embankment.", "parent": "embankment", "attachment": {"parentId": "embankment", "parentSocket": "embankment-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.09, "height": 0.063, "depth": 0.09, "units": "world", "confidence": 0.7}, "transform": {"position": [-1.7, -0.33425, 1.0], "rotation": [0, 0, 0], "scale": [0.09, 0.063, 0.09]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-06", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_06_21.add(mesh_pebble_06_21);
  meshes["pebble-06"] = mesh_pebble_06_21;
  colliders["pebble-06"] = {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["pebble-06"] ??= [];
  destructionGroups["pebble-06"].push(node_pebble_06_21);

  const endpoint_pebble_07_22 = makeAttachmentEndpoint(null);
  const node_pebble_07_22 = new THREE.Group();
  node_pebble_07_22.name = "Pebble07__pivot";
  node_pebble_07_22.scale.set(1, 1, 1);
  if (endpoint_pebble_07_22) {
    node_pebble_07_22.position.copy(endpoint_pebble_07_22.start);
    node_pebble_07_22.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_pebble_07_22.position.set(1.72, -0.33075, 2.6);
    node_pebble_07_22.rotation.set(0.0, 0.0, 0.0);
  }
  node_pebble_07_22.userData.sculptComponent = {"id": "pebble-07", "name": "Pebble07", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble at the foot of the embankment.", "parent": "embankment", "attachment": {"parentId": "embankment", "parentSocket": "embankment-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.11, "height": 0.077, "depth": 0.11, "units": "world", "confidence": 0.7}, "transform": {"position": [1.72, -0.33075, 2.6], "rotation": [0, 0, 0], "scale": [0.11, 0.077, 0.11]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-07", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_07_22.userData.actionProfile = {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-07", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["embankment"] ?? root).add(node_pebble_07_22);
  nodes["pebble-07"] = node_pebble_07_22;
  const mesh_pebble_07_22Geometry = endpoint_pebble_07_22
    ? new THREE.CylinderGeometry(endpoint_pebble_07_22.endRadius, endpoint_pebble_07_22.baseRadius, endpoint_pebble_07_22.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_pebble_07_22) {
    mesh_pebble_07_22Geometry.scale(0.11, 0.077, 0.11);
  }
  const mesh_pebble_07_22 = new THREE.Mesh(
    mesh_pebble_07_22Geometry,
    materialMap["ballast-gravel"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_pebble_07_22.name = "Pebble07";
  if (endpoint_pebble_07_22) {
    mesh_pebble_07_22.position.copy(endpoint_pebble_07_22.midpoint);
    mesh_pebble_07_22.quaternion.copy(endpoint_pebble_07_22.quaternion);
  }
  mesh_pebble_07_22.castShadow = options.castShadow ?? true;
  mesh_pebble_07_22.receiveShadow = options.receiveShadow ?? true;
  mesh_pebble_07_22.userData.sculptComponent = {"id": "pebble-07", "name": "Pebble07", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble at the foot of the embankment.", "parent": "embankment", "attachment": {"parentId": "embankment", "parentSocket": "embankment-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.11, "height": 0.077, "depth": 0.11, "units": "world", "confidence": 0.7}, "transform": {"position": [1.72, -0.33075, 2.6], "rotation": [0, 0, 0], "scale": [0.11, 0.077, 0.11]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-07", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_07_22.add(mesh_pebble_07_22);
  meshes["pebble-07"] = mesh_pebble_07_22;
  colliders["pebble-07"] = {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["pebble-07"] ??= [];
  destructionGroups["pebble-07"].push(node_pebble_07_22);

  const endpoint_pebble_08_23 = makeAttachmentEndpoint(null);
  const node_pebble_08_23 = new THREE.Group();
  node_pebble_08_23.name = "Pebble08__pivot";
  node_pebble_08_23.scale.set(1, 1, 1);
  if (endpoint_pebble_08_23) {
    node_pebble_08_23.position.copy(endpoint_pebble_08_23.start);
    node_pebble_08_23.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_pebble_08_23.position.set(-0.6, -0.33425, 3.8);
    node_pebble_08_23.rotation.set(0.0, 0.0, 0.0);
  }
  node_pebble_08_23.userData.sculptComponent = {"id": "pebble-08", "name": "Pebble08", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble at the foot of the embankment.", "parent": "embankment", "attachment": {"parentId": "embankment", "parentSocket": "embankment-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.09, "height": 0.063, "depth": 0.09, "units": "world", "confidence": 0.7}, "transform": {"position": [-0.6, -0.33425, 3.8], "rotation": [0, 0, 0], "scale": [0.09, 0.063, 0.09]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-08", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_08_23.userData.actionProfile = {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-08", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["embankment"] ?? root).add(node_pebble_08_23);
  nodes["pebble-08"] = node_pebble_08_23;
  const mesh_pebble_08_23Geometry = endpoint_pebble_08_23
    ? new THREE.CylinderGeometry(endpoint_pebble_08_23.endRadius, endpoint_pebble_08_23.baseRadius, endpoint_pebble_08_23.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_pebble_08_23) {
    mesh_pebble_08_23Geometry.scale(0.09, 0.063, 0.09);
  }
  const mesh_pebble_08_23 = new THREE.Mesh(
    mesh_pebble_08_23Geometry,
    materialMap["ballast-gravel"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_pebble_08_23.name = "Pebble08";
  if (endpoint_pebble_08_23) {
    mesh_pebble_08_23.position.copy(endpoint_pebble_08_23.midpoint);
    mesh_pebble_08_23.quaternion.copy(endpoint_pebble_08_23.quaternion);
  }
  mesh_pebble_08_23.castShadow = options.castShadow ?? true;
  mesh_pebble_08_23.receiveShadow = options.receiveShadow ?? true;
  mesh_pebble_08_23.userData.sculptComponent = {"id": "pebble-08", "name": "Pebble08", "level": "micro", "role": "debris", "importance": 0.45, "confidence": 0.7, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Loose pebble at the foot of the embankment.", "parent": "embankment", "attachment": {"parentId": "embankment", "parentSocket": "embankment-socket", "contactType": "embedded", "embedDepth": 0.02, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.09, "height": 0.063, "depth": 0.09, "units": "world", "confidence": 0.7}, "transform": {"position": [-0.6, -0.33425, 3.8], "rotation": [0, 0, 0], "scale": [0.09, 0.063, 0.09]}, "material": "ballast-gravel", "materialLayers": ["ballast-gravel"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 155, 151, 1.0)", "secondaryAlbedo": "rgba(124, 124, 120, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.7, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "debris", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "pebble-08", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_pebble_08_23.add(mesh_pebble_08_23);
  meshes["pebble-08"] = mesh_pebble_08_23;
  colliders["pebble-08"] = {"type": "box", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["pebble-08"] ??= [];
  destructionGroups["pebble-08"].push(node_pebble_08_23);
