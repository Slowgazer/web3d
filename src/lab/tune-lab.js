...
export function bootTuneLab() {
  ...
  sf.add(sky.uniforms.uCloudScale, 'value', 0.2, 3, 0.01).name('云大小(整体)')
  ...
  sf.add(sky.uniforms.uCloudLayerScale.value, 'x', 1, 5, 0.01).name('第2层大小')
  sf.add(sky.uniforms.uCloudLayerScale.value, 'y', 1, 5, 0.01).name('第3层大小')
  sf.add(sky.uniforms.uCloudLayerScale.value, 'z', 1, 5, 0.01).name('第4层大小')
  sf.add(sky.uniforms.uCloudLayerAmp.value, 'x', 0, 0.6, 0.005).name('第2层强度')
  sf.add(sky.uniforms.uCloudLayerAmp.value, 'y', 0, 0.6, 0.005).name('第3层强度')
  sf.add(sky.uniforms.uCloudLayerAmp.value, 'z', 0, 0.6, 0.005).name('第4层强度')
