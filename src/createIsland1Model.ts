...
// Generated from ObjectSculptSpec target: Island Shape 1
// Sculpt build pass: blockout
// This factory is intentionally pass-gated. Finish browser screenshot review before unlocking deeper passes.
export function createIslandShape1Model(options: ProceduralModelOptions = {}): THREE.Group {
  const root = new THREE.Group();
  root.name = "Island Shape 1";
  ...
  node_island_root_0.name = "Island Round__pivot";
  ...
  mesh_island_root_0.name = "Island Round";
  if (endpoint_island_root_0) {
  ...
  mesh_island_root_0.userData.sculptComponent = {"id": "island-root", "name": "Island Round", "level": "macro", "role": "static", "importance": 1.0, "confidence": 0.85, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "Invisible root pivot.", "parent": null, "attachment": null, "dimensions": {"width": 0.001, "height": 0.001, "depth": 0.001, "units": "world", "confidence": 0.85}, "transform": {"position": [0, 0, 0], "rotation": [0, 0, 0], "scale": [0.001, 0.001, 0.001]}, "material": "island-clay", "materialLayers": ["island-clay"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(211, 176, 110, 1.0)", "secondaryAlbedo": "rgba(220, 195, 140, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.85, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "island-root", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  ...
  if (!endpoint_island_body_1) {
    mesh_island_body_1Geometry.scale(1.0, 1.0, 1.14);
  }
  ...
  if (!endpoint_grass_cap_2) {
    mesh_grass_cap_2Geometry.scale(1.0, 1.0, 1.14);
  }
  ...
  const endpoint_bush_04_6 = makeAttachmentEndpoint(null);
  const node_bush_04_6 = new THREE.Group();
  node_bush_04_6.name = "Bush04__pivot";
  node_bush_04_6.scale.set(1, 1, 1);
  if (endpoint_bush_04_6) {
    node_bush_04_6.position.copy(endpoint_bush_04_6.start);
    node_bush_04_6.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_bush_04_6.position.set(-0.16, 0.39899999999999997, 0.5);
    node_bush_04_6.rotation.set(0.0, 0.0, 0.0);
  }
  node_bush_04_6.userData.sculptComponent = {"id": "bush-04", "name": "Bush04", "level": "meso", "role": "vegetation", "importance": 0.7, "confidence": 0.8, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Bush clump seated on the turf surface.", "parent": "grass-cap", "attachment": {"parentId": "grass-cap", "parentSocket": "grass-cap-socket", "contactType": "embedded", "embedDepth": 0.03, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.3, "height": 0.24, "depth": 0.3, "units": "world", "confidence": 0.8}, "transform": {"position": [-0.16, 0.39899999999999997, 0.5], "rotation": [0, 0, 0], "scale": [0.3, 0.24, 0.3]}, "material": "island-bush", "materialLayers": ["island-bush"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(141, 179, 104, 1.0)", "secondaryAlbedo": "rgba(168, 192, 142, 1.0)", "materialClass": "fabric", "materialClassConfidence": 0.8, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "vegetation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "bush-04", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_bush_04_6.userData.actionProfile = {"animationRole": "vegetation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "bush-04", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["grass-cap"] ?? root).add(node_bush_04_6);
  nodes["bush-04"] = node_bush_04_6;
  const mesh_bush_04_6Geometry = endpoint_bush_04_6
    ? new THREE.CylinderGeometry(endpoint_bush_04_6.endRadius, endpoint_bush_04_6.baseRadius, endpoint_bush_04_6.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_bush_04_6) {
    mesh_bush_04_6Geometry.scale(0.3, 0.24, 0.3);
  }
  const mesh_bush_04_6 = new THREE.Mesh(
    mesh_bush_04_6Geometry,
    materialMap["island-bush"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_bush_04_6.name = "Bush04";
  if (endpoint_bush_04_6) {
    mesh_bush_04_6.position.copy(endpoint_bush_04_6.midpoint);
    mesh_bush_04_6.quaternion.copy(endpoint_bush_04_6.quaternion);
  }
  mesh_bush_04_6.castShadow = options.castShadow ?? true;
  mesh_bush_04_6.receiveShadow = options.receiveShadow ?? true;
  mesh_bush_04_6.userData.sculptComponent = {"id": "bush-04", "name": "Bush04", "level": "meso", "role": "vegetation", "importance": 0.7, "confidence": 0.8, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Bush clump seated on the turf surface.", "parent": "grass-cap", "attachment": {"parentId": "grass-cap", "parentSocket": "grass-cap-socket", "contactType": "embedded", "embedDepth": 0.03, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.3, "height": 0.24, "depth": 0.3, "units": "world", "confidence": 0.8}, "transform": {"position": [-0.16, 0.39899999999999997, 0.5], "rotation": [0, 0, 0], "scale": [0.3, 0.24, 0.3]}, "material": "island-bush", "materialLayers": ["island-bush"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(141, 179, 104, 1.0)", "secondaryAlbedo": "rgba(168, 192, 142, 1.0)", "materialClass": "fabric", "materialClassConfidence": 0.8, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "vegetation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "bush-04", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_bush_04_6.add(mesh_bush_04_6);
  meshes["bush-04"] = mesh_bush_04_6;
  colliders["bush-04"] = {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["bush-04"] ??= [];
  destructionGroups["bush-04"].push(node_bush_04_6);

  const endpoint_rock_01_7 = makeAttachmentEndpoint(null);
  const node_rock_01_7 = new THREE.Group();
  node_rock_01_7.name = "Rock01__pivot";
  node_rock_01_7.scale.set(1, 1, 1);
  if (endpoint_rock_01_7) {
    node_rock_01_7.position.copy(endpoint_rock_01_7.start);
    node_rock_01_7.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_rock_01_7.position.set(0.45, 0.36669999999999997, 0.25);
    node_rock_01_7.rotation.set(0.0, 0.0, 0.0);
  }
  node_rock_01_7.userData.sculptComponent = {"id": "rock-01", "name": "Rock01", "level": "meso", "role": "rock", "importance": 0.7, "confidence": 0.78, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Grey rock half-buried in the turf.", "parent": "grass-cap", "attachment": {"parentId": "grass-cap", "parentSocket": "grass-cap-socket", "contactType": "embedded", "embedDepth": 0.03, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.2, "height": 0.124, "depth": 0.18000000000000002, "units": "world", "confidence": 0.78}, "transform": {"position": [0.45, 0.36669999999999997, 0.25], "rotation": [0, 0, 0], "scale": [0.2, 0.124, 0.18000000000000002]}, "material": "island-rock", "materialLayers": ["island-rock"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 188, 123, 1.0)", "secondaryAlbedo": "rgba(188, 204, 149, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.78, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-01", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": ["rock-grey-mottle"], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_rock_01_7.userData.actionProfile = {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-01", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["grass-cap"] ?? root).add(node_rock_01_7);
  nodes["rock-01"] = node_rock_01_7;
  const mesh_rock_01_7Geometry = endpoint_rock_01_7
    ? new THREE.CylinderGeometry(endpoint_rock_01_7.endRadius, endpoint_rock_01_7.baseRadius, endpoint_rock_01_7.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_rock_01_7) {
    mesh_rock_01_7Geometry.scale(0.2, 0.124, 0.18000000000000002);
  }
  const mesh_rock_01_7 = new THREE.Mesh(
    mesh_rock_01_7Geometry,
    materialMap["island-rock"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_rock_01_7.name = "Rock01";
  if (endpoint_rock_01_7) {
    mesh_rock_01_7.position.copy(endpoint_rock_01_7.midpoint);
    mesh_rock_01_7.quaternion.copy(endpoint_rock_01_7.quaternion);
  }
  mesh_rock_01_7.castShadow = options.castShadow ?? true;
  mesh_rock_01_7.receiveShadow = options.receiveShadow ?? true;
  mesh_rock_01_7.userData.sculptComponent = {"id": "rock-01", "name": "Rock01", "level": "meso", "role": "rock", "importance": 0.7, "confidence": 0.78, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Grey rock half-buried in the turf.", "parent": "grass-cap", "attachment": {"parentId": "grass-cap", "parentSocket": "grass-cap-socket", "contactType": "embedded", "embedDepth": 0.03, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.2, "height": 0.124, "depth": 0.18000000000000002, "units": "world", "confidence": 0.78}, "transform": {"position": [0.45, 0.36669999999999997, 0.25], "rotation": [0, 0, 0], "scale": [0.2, 0.124, 0.18000000000000002]}, "material": "island-rock", "materialLayers": ["island-rock"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 188, 123, 1.0)", "secondaryAlbedo": "rgba(188, 204, 149, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.78, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-01", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": ["rock-grey-mottle"], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_rock_01_7.add(mesh_rock_01_7);
  meshes["rock-01"] = mesh_rock_01_7;
  colliders["rock-01"] = {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["rock-01"] ??= [];
  destructionGroups["rock-01"].push(node_rock_01_7);

  const endpoint_rock_02_8 = makeAttachmentEndpoint(null);
  const node_rock_02_8 = new THREE.Group();
  node_rock_02_8.name = "Rock02__pivot";
  node_rock_02_8.scale.set(1, 1, 1);
  if (endpoint_rock_02_8) {
    node_rock_02_8.position.copy(endpoint_rock_02_8.start);
    node_rock_02_8.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_rock_02_8.position.set(-0.4, 0.36290249999999996, -0.25);
    node_rock_02_8.rotation.set(0.0, 0.0, 0.0);
  }
  node_rock_02_8.userData.sculptComponent = {"id": "rock-02", "name": "Rock02", "level": "meso", "role": "rock", "importance": 0.7, "confidence": 0.78, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Grey rock half-buried in the turf.", "parent": "grass-cap", "attachment": {"parentId": "grass-cap", "parentSocket": "grass-cap-socket", "contactType": "embedded", "embedDepth": 0.03, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.165, "height": 0.1023, "depth": 0.14850000000000002, "units": "world", "confidence": 0.78}, "transform": {"position": [-0.4, 0.36290249999999996, -0.25], "rotation": [0, 0, 0], "scale": [0.165, 0.1023, 0.14850000000000002]}, "material": "island-rock", "materialLayers": ["island-rock"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 188, 123, 1.0)", "secondaryAlbedo": "rgba(188, 204, 149, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.78, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-02", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_rock_02_8.userData.actionProfile = {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-02", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["grass-cap"] ?? root).add(node_rock_02_8);
  nodes["rock-02"] = node_rock_02_8;
  const mesh_rock_02_8Geometry = endpoint_rock_02_8
    ? new THREE.CylinderGeometry(endpoint_rock_02_8.endRadius, endpoint_rock_02_8.baseRadius, endpoint_rock_02_8.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_rock_02_8) {
    mesh_rock_02_8Geometry.scale(0.165, 0.1023, 0.14850000000000002);
  }
  const mesh_rock_02_8 = new THREE.Mesh(
    mesh_rock_02_8Geometry,
    materialMap["island-rock"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_rock_02_8.name = "Rock02";
  if (endpoint_rock_02_8) {
    mesh_rock_02_8.position.copy(endpoint_rock_02_8.midpoint);
    mesh_rock_02_8.quaternion.copy(endpoint_rock_02_8.quaternion);
  }
  mesh_rock_02_8.castShadow = options.castShadow ?? true;
  mesh_rock_02_8.receiveShadow = options.receiveShadow ?? true;
  mesh_rock_02_8.userData.sculptComponent = {"id": "rock-02", "name": "Rock02", "level": "meso", "role": "rock", "importance": 0.7, "confidence": 0.78, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Grey rock half-buried in the turf.", "parent": "grass-cap", "attachment": {"parentId": "grass-cap", "parentSocket": "grass-cap-socket", "contactType": "embedded", "embedDepth": 0.03, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.165, "height": 0.1023, "depth": 0.14850000000000002, "units": "world", "confidence": 0.78}, "transform": {"position": [-0.4, 0.36290249999999996, -0.25], "rotation": [0, 0, 0], "scale": [0.165, 0.1023, 0.14850000000000002]}, "material": "island-rock", "materialLayers": ["island-rock"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 188, 123, 1.0)", "secondaryAlbedo": "rgba(188, 204, 149, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.78, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-02", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_rock_02_8.add(mesh_rock_02_8);
  meshes["rock-02"] = mesh_rock_02_8;
  colliders["rock-02"] = {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["rock-02"] ??= [];
  destructionGroups["rock-02"].push(node_rock_02_8);

  const endpoint_rock_03_9 = makeAttachmentEndpoint(null);
  const node_rock_03_9 = new THREE.Group();
  node_rock_03_9.name = "Rock03__pivot";
  node_rock_03_9.scale.set(1, 1, 1);
  if (endpoint_rock_03_9) {
    node_rock_03_9.position.copy(endpoint_rock_03_9.start);
    node_rock_03_9.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_rock_03_9.position.set(0.15, 0.35910499999999995, 0.52);
    node_rock_03_9.rotation.set(0.0, 0.0, 0.0);
  }
  node_rock_03_9.userData.sculptComponent = {"id": "rock-03", "name": "Rock03", "level": "meso", "role": "rock", "importance": 0.7, "confidence": 0.78, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Grey rock half-buried in the turf.", "parent": "grass-cap", "attachment": {"parentId": "grass-cap", "parentSocket": "grass-cap-socket", "contactType": "embedded", "embedDepth": 0.03, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.13, "height": 0.0806, "depth": 0.117, "units": "world", "confidence": 0.78}, "transform": {"position": [0.15, 0.35910499999999995, 0.52], "rotation": [0, 0, 0], "scale": [0.13, 0.0806, 0.117]}, "material": "island-rock", "materialLayers": ["island-rock"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 188, 123, 1.0)", "secondaryAlbedo": "rgba(188, 204, 149, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.78, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-03", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_rock_03_9.userData.actionProfile = {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-03", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["grass-cap"] ?? root).add(node_rock_03_9);
  nodes["rock-03"] = node_rock_03_9;
  const mesh_rock_03_9Geometry = endpoint_rock_03_9
    ? new THREE.CylinderGeometry(endpoint_rock_03_9.endRadius, endpoint_rock_03_9.baseRadius, endpoint_rock_03_9.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_rock_03_9) {
    mesh_rock_03_9Geometry.scale(0.13, 0.0806, 0.117);
  }
  const mesh_rock_03_9 = new THREE.Mesh(
    mesh_rock_03_9Geometry,
    materialMap["island-rock"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_rock_03_9.name = "Rock03";
  if (endpoint_rock_03_9) {
    mesh_rock_03_9.position.copy(endpoint_rock_03_9.midpoint);
    mesh_rock_03_9.quaternion.copy(endpoint_rock_03_9.quaternion);
  }
  mesh_rock_03_9.castShadow = options.castShadow ?? true;
  mesh_rock_03_9.receiveShadow = options.receiveShadow ?? true;
  mesh_rock_03_9.userData.sculptComponent = {"id": "rock-03", "name": "Rock03", "level": "meso", "role": "rock", "importance": 0.7, "confidence": 0.78, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Grey rock half-buried in the turf.", "parent": "grass-cap", "attachment": {"parentId": "grass-cap", "parentSocket": "grass-cap-socket", "contactType": "embedded", "embedDepth": 0.03, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.13, "height": 0.0806, "depth": 0.117, "units": "world", "confidence": 0.78}, "transform": {"position": [0.15, 0.35910499999999995, 0.52], "rotation": [0, 0, 0], "scale": [0.13, 0.0806, 0.117]}, "material": "island-rock", "materialLayers": ["island-rock"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 188, 123, 1.0)", "secondaryAlbedo": "rgba(188, 204, 149, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.78, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-03", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_rock_03_9.add(mesh_rock_03_9);
  meshes["rock-03"] = mesh_rock_03_9;
  colliders["rock-03"] = {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["rock-03"] ??= [];
  destructionGroups["rock-03"].push(node_rock_03_9);

  const endpoint_rock_04_10 = makeAttachmentEndpoint(null);
  const node_rock_04_10 = new THREE.Group();
  node_rock_04_10.name = "Rock04__pivot";
  node_rock_04_10.scale.set(1, 1, 1);
  if (endpoint_rock_04_10) {
    node_rock_04_10.position.copy(endpoint_rock_04_10.start);
    node_rock_04_10.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_rock_04_10.position.set(0.5718811708090112, 0.2156342857142857, 0.7206607568572848);
    node_rock_04_10.rotation.set(0.0, 0.0, 0.0);
  }
  node_rock_04_10.userData.sculptComponent = {"id": "rock-04", "name": "Rock04", "level": "meso", "role": "rock", "importance": 0.7, "confidence": 0.75, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Grey rock lodged on the clay wall.", "parent": "island-body", "attachment": {"parentId": "island-body", "parentSocket": "island-body-socket", "contactType": "embedded", "embedDepth": 0.03, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.16, "height": 0.0992, "depth": 0.14400000000000002, "units": "world", "confidence": 0.75}, "transform": {"position": [0.5718811708090112, 0.2156342857142857, 0.7206607568572848], "rotation": [0, 0, 0], "scale": [0.16, 0.0992, 0.14400000000000002]}, "material": "island-rock", "materialLayers": ["island-rock"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 188, 123, 1.0)", "secondaryAlbedo": "rgba(188, 204, 149, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.75, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-04", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_rock_04_10.userData.actionProfile = {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-04", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}};
  (nodes["island-body"] ?? root).add(node_rock_04_10);
  nodes["rock-04"] = node_rock_04_10;
  const mesh_rock_04_10Geometry = endpoint_rock_04_10
    ? new THREE.CylinderGeometry(endpoint_rock_04_10.endRadius, endpoint_rock_04_10.baseRadius, endpoint_rock_04_10.length, 32, 12)
    : new THREE.SphereGeometry(0.5, 64, 40);
  if (!endpoint_rock_04_10) {
    mesh_rock_04_10Geometry.scale(0.16, 0.0992, 0.14400000000000002);
  }
  const mesh_rock_04_10 = new THREE.Mesh(
    mesh_rock_04_10Geometry,
    materialMap["island-rock"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_rock_04_10.name = "Rock04";
  if (endpoint_rock_04_10) {
    mesh_rock_04_10.position.copy(endpoint_rock_04_10.midpoint);
    mesh_rock_04_10.quaternion.copy(endpoint_rock_04_10.quaternion);
  }
  mesh_rock_04_10.castShadow = options.castShadow ?? true;
  mesh_rock_04_10.receiveShadow = options.receiveShadow ?? true;
  mesh_rock_04_10.userData.sculptComponent = {"id": "rock-04", "name": "Rock04", "level": "meso", "role": "rock", "importance": 0.7, "confidence": 0.75, "primitive": "sphere", "topologyClass": "assembled-solid", "topologyRationale": "Grey rock lodged on the clay wall.", "parent": "island-body", "attachment": {"parentId": "island-body", "parentSocket": "island-body-socket", "contactType": "embedded", "embedDepth": 0.03, "gapTolerance": 0.01, "localStart": [0, 0, 0], "localEnd": [0, 0, 0]}, "dimensions": {"width": 0.16, "height": 0.0992, "depth": 0.14400000000000002, "units": "world", "confidence": 0.75}, "transform": {"position": [0.5718811708090112, 0.2156342857142857, 0.7206607568572848], "rotation": [0, 0, 0], "scale": [0.16, 0.0992, 0.14400000000000002]}, "material": "island-rock", "materialLayers": ["island-rock"], "colorMaterialRecipe": {"dominantAlbedo": "rgba(155, 188, 123, 1.0)", "secondaryAlbedo": "rgba(188, 204, 149, 1.0)", "materialClass": "stone", "materialClassConfidence": 0.75, "source": "reference-image pixel sampling"}, "actionProfile": {"animationRole": "rock", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.85}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": false}, "sockets": [], "collider": {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false}, "destruction": {"breakable": false, "fractureGroup": "rock-04", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "base"}}, "localFeatures": [], "evidenceRefs": ["full-object"], "fidelityTier": "form-refinement"};
  node_rock_04_10.add(mesh_rock_04_10);
  meshes["rock-04"] = mesh_rock_04_10;
  colliders["rock-04"] = {"type": "sphere", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": false};
  destructionGroups["rock-04"] ??= [];
  destructionGroups["rock-04"].push(node_rock_04_10);
...
export function createIslandShape1LookDevLights(
  mode: 'neutral' | 'grazing' | 'reference' = 'neutral',
): THREE.Group {
  const lights = new THREE.Group();
  lights.name = "Island Shape 1 look-dev lights";
...
export function createIslandShape1Environment(renderer: THREE.WebGLRenderer): THREE.Texture {
...
export function frameIslandShape1Camera(
...
export function createIslandShape1PresentationComposer(
...
export function configureIslandShape1Renderer(renderer: THREE.WebGLRenderer): void {
...
export function createIslandShape1InspectControls(
  camera: THREE.Camera,
